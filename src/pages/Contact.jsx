...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>
          Contact Wedding Gift House | Wholesale Wedding Gifts in Bengaluru
        </title>
        <meta
          name="description"
          content="Contact Wedding Gift House for wholesale wedding gifts, return gifts and festive packaging. Located in Bengaluru, Karnataka. Bulk orders welcome."
        />
        <link rel="canonical" href="https://gifthouse.vercel.app/contact" />
      </Helmet>
