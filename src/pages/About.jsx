...
const About = () => {
  return (
    <>
      <Helmet>
        <title>
          About Wedding Gift House | Wholesale Wedding Gift Supplier
        </title>
        <meta
          name="description"
          content="Wedding Gift House is a trusted wholesale supplier of wedding gifts, return gifts, trays and festive packaging inspired by Indian wedding traditions."
        />
        <link rel="canonical" href="https://gifthouse.vercel.app/about" />
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="flex flex-col gap-6 text-gray-700 text-sm leading-relaxed">
              ...
              <p>
                ...
                collections are inspired by Indian celebrations — rich in
                culture, warmth, and craftsmanship.
              </p>

              <p>
                From handcrafted baskets and decorative trays to premium gift
                boxes and bulk gifting essentials, we support families,
                retailers, and event planners with products that elevate every
                ceremony.
              </p>
